...
public class Mage extends Personnage implements Combattant{
     ...
     * @param posEl position du mage
     */
    
    public Mage(String nom, int ptMana, int pourcentageMag, int pourcenatageResistMag, int degMag, int distAttMax, int ptVie, int pourcentageAtt, int pourcentagePar, int degAtt, int ptPar, Point2D posEl){
    ...
    public Mage(String nom, int ptMana, int pourcentageMag, int pourcenatageResistMag, int degMag, int distAttMax, Point2D posEl) {
    ...
    /**
     * 
     * Cette méthode permet de lancer un combat entre le mage et une créature
